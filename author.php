...
<body>
    ...
    <div class="row">
        <div class="col-lg-9 bg-transparent mt-2">
            <center>
                <h1 style="font-size: xx-large;">RONALD MUGABO</h1>
                <p>This is a simple information about me your know author.</p>
                <br>
                <p>Never miss out on my new blogs daily</p>
            </center>
        </div>
    </div>
        ...
        <div id="carouselExampleIndicators" class="carousel slide bg-secondary">
            ...
            <div class="carousel-inner mt-3">
              <div class="carousel-item active">
                <img src="https://th.bing.com/th/id/OIP.IQYP39mHmarlx--Es-wbNgAAAA?w=252&h=182&c=7&r=0&o=5&pid=1.7" alt="GFG" width="800px" height="500" alt="...">
              </div>
              <div class="carousel-item">
                <img src="https://th.bing.com/th/id/OIP.97mb8bx8pijPAPCQau8qEAHaFW?w=246&h=180&c=7&r=0&o=5&pid=1.7" alt="GFG" width="800px" height="500" alt="...">
              </div>
              <div class="carousel-item">
                <img src="https://th.bing.com/th/id/OIP.NSXsorJqTTtb5rb0XtdfYAHaCu?w=341&h=128&c=7&r=0&o=5&pid=1.7" alt="GFG" width="800px" height="500" alt="...">
              </div>
            </div>
