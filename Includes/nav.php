            ...
            <div class="fixed-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="author.php">About </a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <li><a class="dropdown-item text-white bg-dark" href="technlogies.php">Blog 1</a></li>
                            <li><a class="dropdown-item bg-dark text-white" href="fash.php">Blog 2</a></li>
                            </ul>
                        </li>
